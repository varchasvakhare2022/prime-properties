...
import { Home, User, Shield, Zap, Heart, LogOut } from 'lucide-react';
          ...
          <GradientBorder>
            <div className="glass-effect p-6 rounded-2xl border border-white/10">
              ...
              <div className="text-center mb-6">
                ...
                >
                  {isAuthenticated ? (
                    <>Welcome back, <span className="gradient-text-primary">{user?.name || user?.username}</span>!</>
                  ) : (
                ...
                >
                  {isAuthenticated ? (
                    <>You are already signed in. You can continue browsing or sign out below.</>
                  ) : (
              ...
              {/* Main Action Buttons */}
              {isAuthenticated ? (
                // User is already signed in - show user info and sign out
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  >
                    <div className="text-center">
                      <div className="text-white font-semibold mb-1">{user?.name || user?.username}</div>
                  ...
                  <div className="space-y-3">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={logout}
                      className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-white/10 backdrop-blur-md border border-white/20 text-white/80 font-semibold rounded-xl hover:bg-white/20 transition-all duration-300"
                    >
